        ...
        <div className="bg-slate-900/70 border border-slate-800 rounded-xl p-8 max-w-md w-full">
          <div className="text-center mb-6">
            ...
            <p className="text-slate-400">
              This meeting requires a password to view
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 text-sm text-slate-400">
            ...
            {meeting.duration && (
              <div className="flex items-center gap-2">
                ...
                {Math.floor(meeting.duration % 60)}s
              </div>
            )}
            {totalParticipants > 0 && (
              <div className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {meeting.summary.sentiment && (
                <div className="bg-slate-900/70 border border-slate-800 rounded-xl p-6">
                  ...
                  <div
                    className={`text-2xl font-semibold ${getSentimentColor(meeting.summary.sentiment)}`}
                  >
                    {getSentimentEmoji(meeting.summary.sentiment)}{" "}
                    {meeting.summary.sentiment.charAt(0).toUpperCase() +
                      meeting.summary.sentiment.slice(1)}
                  </div>
                </div>
              )}
                    ...
                    {meeting.summary.actionItems.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {item.priority && (
                            <span
                              className={`px-2 py-1 rounded border text-xs ${getPriorityColor(item.priority)}`}
                            >
